...
int main(int argc, char *argv[]) try
{
	...
	src_noiseless = imread( original, 1 );
	...
	threshold( src_hidden_message_dereorderd, src_hidden_message_dereorderd, 254, 255, 0  );//olny black and white
	...
	imshow( source, src_message );
	namedWindow( "Hidden message", CV_WINDOW_AUTOSIZE );
	imshow(  "Hidden message", src_hidden_message );
